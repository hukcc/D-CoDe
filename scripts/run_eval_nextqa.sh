...
SELECT_FRAMES=${SELECT_FRAMES:-"18"}
UNIFORM_RATIO=${UNIFORM_RATIO:-"0.85"}
# D-CoDe token selection parameters
DCODE_TOP_K=${DCODE_TOP_K:-"360"}
DCODE_MERGE_STRATEGY=${DCODE_MERGE_STRATEGY:-"mean"}
DCODE_SIMILARITY_THRESHOLD=${DCODE_SIMILARITY_THRESHOLD:-"0.9"}
# Generation parameters
COT_MAX_NEW_TOKENS=${COT_MAX_NEW_TOKENS:-"64"}
ANSWER_MAX_NEW_TOKENS=${ANSWER_MAX_NEW_TOKENS:-"16"}
# CoT parameters (requires OpenAI API key)
ENABLE_COT=${ENABLE_COT:-"true"}
